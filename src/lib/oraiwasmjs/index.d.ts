...
declare class OraiwasmJs extends Cosmos {
  ...
  execute(params: {
    signerOrChild: bip32.BIP32Interface | OfflineDirectSigner;
    rawInputs: RawInput[];
    fees?: number | Coin[];
    gasLimits?: number | string;
    memo?: string | undefined;
    gasMultiplier?: number;
    timeoutHeight?: number;
    timeoutIntervalCheck?: number;
  ...
  getHandleMessage(
    ...
    sender: string,
    sentFunds: Coin[]
  ): Cosmos.message.google.protobuf.Any;
  getHandleMessageSimulate(
    contract: string,
    msg: any,
    sender: string,
    sentFunds: Coin[]
